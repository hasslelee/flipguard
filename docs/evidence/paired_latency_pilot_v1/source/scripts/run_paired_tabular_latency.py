...
def aggregate_pair_rows(
    ...
    for (numerator, denominator), group in sorted(grouped.items()):
        ...
        total_ratio = geometric_mean(total_ratios)
        eval_ratio = geometric_mean(eval_ratios)
        ...
        output.append(
            {
                ...
                "min_workload_total_ratio": min(total_ratios),
                "max_workload_total_ratio": max(total_ratios),
...
def main() -> int:
    ...
    summary = {
        ...
        "protocol": {
            ...
            "aggregate_inference_unit": "workload_instance",
