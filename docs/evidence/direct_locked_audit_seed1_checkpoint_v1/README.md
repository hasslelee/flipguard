# Direct Locked Audit Evidence: direct_locked_audit_seed1_checkpoint_v1

## Result

- Split seeds in this pack: `1`
...
python3 scripts/freeze_direct_locked_audit_evidence.py \
  --output-root docs/evidence/direct_locked_audit_seed1_checkpoint_v1 \
  --verify
```
