# Direct Locked Audit Evidence: direct_locked_audit_seeds1_3_checkpoint_v1

## Result

- Split seeds in this pack: `1,2,3`
- Frozen configurations audited: `30`
- Locked-audit PASS: `30/30`
- Configuration trials: `30`
- Fresh-key runs: `90`
- Retuning during audit: `0`
- Total audit V_cert: `4871`
- Total audit V_amb: `109`
...
python3 scripts/freeze_direct_locked_audit_evidence.py \
  --output-root docs/evidence/direct_locked_audit_seeds1_3_checkpoint_v1 \
  --verify
```
