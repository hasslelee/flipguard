# Direct Locked Audit Evidence: direct_locked_audit_seed0_development_v1

## Result

- Split seeds in this pack: `0`
- Frozen configurations audited: `10`
- Locked-audit PASS: `10/10`
- Configuration trials: `14`
- Fresh-key runs: `30`
...
python3 scripts/freeze_direct_locked_audit_evidence.py \
  --output-root docs/evidence/direct_locked_audit_seed0_development_v1 \
  --verify
```
...
10 selection results and the matching split manifests,
locked-audit results, execution ledger, and aggregate CSV/JSON outputs.

## Claim Boundary

This is frozen preliminary evidence for the recorded split set and
