module @"traced/LinearRegression.mlir" {
  func.func @_hecate_LinearRegression(%arg0: tensor<1x!ckks.poly<2 * 0>>, %arg1: tensor<1x!ckks.poly<2 * 0>>) -> (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) attributes {arg_level = array<i64: 5, 5>, arg_scale = array<i64: 34, 34>, init_level = 5 : i64, res_level = array<i64: 2, 2>, res_scale = array<i64: 92, 58>} {
    ...
    %7 = "ckks.encode"(%6) {level = 5 : i64, scale = 34 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %63 = "ckks.encode"(%62) {level = 4 : i64, scale = 34 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %115 = "ckks.encode"(%114) {level = 4 : i64, scale = 34 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %119 = "ckks.encode"(%118) {level = 4 : i64, scale = 34 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %125 = "ckks.encode"(%124) {level = 4 : i64, scale = 76 : i64, value = 0 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %136 = "ckks.encode"(%135) {level = 3 : i64, scale = 8 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %144 = "ckks.encode"(%143) {level = 3 : i64, scale = 16 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %153 = "ckks.encode"(%152) {level = 3 : i64, scale = 34 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %257 = "ckks.encode"(%256) {level = 2 : i64, scale = 34 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %261 = "ckks.encode"(%260) {level = 3 : i64, scale = 34 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %278 = "ckks.encode"(%277) {level = 2 : i64, scale = 16 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
