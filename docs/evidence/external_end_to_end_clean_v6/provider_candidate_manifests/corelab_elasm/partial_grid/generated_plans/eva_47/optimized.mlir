module @"traced/LinearRegression.mlir" {
  func.func @_hecate_LinearRegression(%arg0: tensor<1x!ckks.poly<2 * 0>>, %arg1: tensor<1x!ckks.poly<2 * 0>>) -> (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) attributes {arg_level = array<i64: 7, 7>, arg_scale = array<i64: 47, 47>, init_level = 7 : i64, res_level = array<i64: 2, 2>, res_scale = array<i64: 102, 81>} {
    ...
    %7 = "ckks.encode"(%6) {level = 7 : i64, scale = 47 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %63 = "ckks.encode"(%62) {level = 5 : i64, scale = 47 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %115 = "ckks.encode"(%114) {level = 6 : i64, scale = 47 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %121 = "ckks.encode"(%120) {level = 5 : i64, scale = 47 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %127 = "ckks.encode"(%126) {level = 5 : i64, scale = 68 : i64, value = 0 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %138 = "ckks.encode"(%137) {level = 4 : i64, scale = 26 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %146 = "ckks.encode"(%145) {level = 4 : i64, scale = 34 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %157 = "ckks.encode"(%156) {level = 3 : i64, scale = 47 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %211 = "ckks.encode"(%210) {level = 4 : i64, scale = 47 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %265 = "ckks.encode"(%264) {level = 2 : i64, scale = 47 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %269 = "ckks.encode"(%268) {level = 3 : i64, scale = 47 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %278 = "ckks.encode"(%277) {level = 2 : i64, scale = 34 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %284 = "ckks.encode"(%283) {level = 2 : i64, scale = 26 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
