module @"traced/LinearRegression.mlir" {
  func.func @_hecate_LinearRegression(%arg0: tensor<1x!ckks.poly<2 * 0>>, %arg1: tensor<1x!ckks.poly<2 * 0>>) -> (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) attributes {arg_level = array<i64: 4, 4>, arg_scale = array<i64: 21, 21>, init_level = 4 : i64, res_level = array<i64: 2, 2>, res_scale = array<i64: 66, 63>} {
    ...
    %7 = "ckks.encode"(%6) {level = 4 : i64, scale = 21 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %59 = "ckks.encode"(%58) {level = 3 : i64, scale = 21 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %63 = "ckks.encode"(%62) {level = 3 : i64, scale = 21 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %115 = "ckks.encode"(%114) {level = 4 : i64, scale = 21 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %121 = "ckks.encode"(%120) {level = 3 : i64, scale = 21 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %125 = "ckks.encode"(%124) {level = 3 : i64, scale = 24 : i64, value = 0 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %134 = "ckks.encode"(%133) {level = 3 : i64, scale = 18 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %142 = "ckks.encode"(%141) {level = 3 : i64, scale = 42 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %151 = "ckks.encode"(%150) {level = 2 : i64, scale = 21 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %255 = "ckks.encode"(%254) {level = 2 : i64, scale = 21 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %264 = "ckks.encode"(%263) {level = 2 : i64, scale = 42 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %270 = "ckks.encode"(%269) {level = 2 : i64, scale = 18 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
