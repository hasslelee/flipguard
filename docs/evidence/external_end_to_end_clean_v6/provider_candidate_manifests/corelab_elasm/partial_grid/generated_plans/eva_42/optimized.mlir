module @"traced/LinearRegression.mlir" {
  func.func @_hecate_LinearRegression(%arg0: tensor<1x!ckks.poly<2 * 0>>, %arg1: tensor<1x!ckks.poly<2 * 0>>) -> (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) attributes {arg_level = array<i64: 6, 6>, arg_scale = array<i64: 42, 42>, init_level = 6 : i64, res_level = array<i64: 2, 2>, res_scale = array<i64: 96, 66>} {
    ...
    %7 = "ckks.encode"(%6) {level = 6 : i64, scale = 42 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %63 = "ckks.encode"(%62) {level = 5 : i64, scale = 42 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %115 = "ckks.encode"(%114) {level = 5 : i64, scale = 42 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %121 = "ckks.encode"(%120) {level = 5 : i64, scale = 42 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %127 = "ckks.encode"(%126) {level = 4 : i64, scale = 48 : i64, value = 0 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %136 = "ckks.encode"(%135) {level = 4 : i64, scale = 24 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %144 = "ckks.encode"(%143) {level = 4 : i64, scale = 48 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %153 = "ckks.encode"(%152) {level = 3 : i64, scale = 42 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %207 = "ckks.encode"(%206) {level = 4 : i64, scale = 42 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    %208 = tensor.empty() : tensor<1x!ckks.poly<2 * 0>>
    %209 = "ckks.mulcp"(%208, %147, %207) : (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<2 * 0>>
    ...
    %261 = "ckks.encode"(%260) {level = 2 : i64, scale = 42 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %265 = "ckks.encode"(%264) {level = 3 : i64, scale = 42 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %271 = "ckks.modswitchc"(%270, %129) {downFactor = 2 : i64} : (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) -> tensor<1x!ckks.poly<2 * 0>>
    %272 = tensor.empty() : tensor<1x!ckks.poly<2 * 0>>
    %273 = tensor.empty() : tensor<1x!ckks.poly<1 * 0>>
    %274 = "ckks.encode"(%273) {level = 2 : i64, scale = 48 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %280 = "ckks.encode"(%279) {level = 2 : i64, scale = 12 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    %281 = "ckks.mulcp"(%278, %269, %280) : (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<2 * 0>>
    %282 = tensor.empty() : tensor<1x!ckks.poly<2 * 0>>
    %283 = "ckks.modswitchc"(%282, %125) {downFactor = 2 : i64} : (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) -> tensor<1x!ckks.poly<2 * 0>>
