module @"traced/LinearRegression.mlir" {
  func.func @_hecate_LinearRegression(%arg0: tensor<1x!ckks.poly<2 * 0>>, %arg1: tensor<1x!ckks.poly<2 * 0>>) -> (tensor<1x!ckks.poly<2 * 0>>, tensor<1x!ckks.poly<2 * 0>>) attributes {arg_level = array<i64: 6, 6>, arg_scale = array<i64: 36, 36>, init_level = 6 : i64, res_level = array<i64: 2, 2>, res_scale = array<i64: 84, 72>} {
    ...
    %7 = "ckks.encode"(%6) {level = 6 : i64, scale = 36 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %63 = "ckks.encode"(%62) {level = 5 : i64, scale = 36 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %115 = "ckks.encode"(%114) {level = 5 : i64, scale = 36 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %119 = "ckks.encode"(%118) {level = 5 : i64, scale = 36 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %125 = "ckks.encode"(%124) {level = 5 : i64, scale = 84 : i64, value = 0 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %136 = "ckks.encode"(%135) {level = 4 : i64, scale = 12 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %144 = "ckks.encode"(%143) {level = 4 : i64, scale = 24 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %155 = "ckks.encode"(%154) {level = 3 : i64, scale = 36 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %209 = "ckks.encode"(%208) {level = 3 : i64, scale = 36 : i64, value = 2 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %263 = "ckks.encode"(%262) {level = 3 : i64, scale = 36 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %269 = "ckks.encode"(%268) {level = 2 : i64, scale = 36 : i64, value = 1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %274 = "ckks.encode"(%273) {level = 2 : i64, scale = 36 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
    ...
    %284 = "ckks.encode"(%283) {level = 2 : i64, scale = 24 : i64, value = -1 : i64} : (tensor<1x!ckks.poly<1 * 0>>) -> tensor<1x!ckks.poly<1 * 0>>
