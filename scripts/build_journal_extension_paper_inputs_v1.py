...
def collect(root: Path, source_commit: str) -> dict[str, object]:
    ...
    inventory_rows = [
        ...
        ["Primary paired latency", "3 arms x 50 x 6 measured passes x 3 order/repeat rows", 5400, "raw latency record; 10 clusters inferential", "RC2 paired claim unchanged"],
