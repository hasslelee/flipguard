...
if [[ ! -f external/v7/status/slothe/0001-source/current_stage.txt ]] || \
  [[ "$(<external/v7/status/slothe/0001-source/current_stage.txt)" != PASS ]]; then
...
test "$(git -C external/v7/sources/slothe rev-parse HEAD)" = 33ccff3519c9df1dc255420e8a1bfe4da501b1f0
