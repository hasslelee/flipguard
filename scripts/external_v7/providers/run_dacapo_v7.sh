...
if [[ ! -f external/v7/status/dacapo/0001-source/current_stage.txt ]] || \
  [[ "$(<external/v7/status/dacapo/0001-source/current_stage.txt)" != PASS ]]; then
...
test "$(git -C external/v7/sources/dacapo rev-parse HEAD)" = 4616402710f39df3e5f5bd7930a6c036025aaac3
