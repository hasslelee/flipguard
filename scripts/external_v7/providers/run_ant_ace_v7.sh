...
if [[ ! -f external/v7/status/ant-ace/0001-source/current_stage.txt ]] || \
  [[ "$(<external/v7/status/ant-ace/0001-source/current_stage.txt)" != PASS ]]; then
...
test "$(git -C external/v7/sources/ant-ace rev-parse HEAD)" = 15c95a7346d89355d68d5bf4fe8ab3b952740e1a
