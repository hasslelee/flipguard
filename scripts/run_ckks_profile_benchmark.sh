...
echo "output_tag=$OUTPUT_TAG warmup_runs=$WARMUP_RUNS measurement_runs=$MEASUREMENT_RUNS profile_names=$PROFILE_NAMES score_abs_error_cap=$SCORE_ABS_ERROR_CAP score_rel_error_cap=$SCORE_REL_ERROR_CAP"
echo
