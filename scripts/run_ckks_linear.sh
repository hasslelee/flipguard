...
echo "== FlipGuard CKKS linear reproducibility run =="
...
echo "== 2. Running CKKS linear experiment =="
go run ./cmd/flipguard -experiment ckks_linear
echo

RESULT_DIR="results/ckks_linear"
...
echo "== 4. CKKS linear summary =="
cat "$SUMMARY_CSV"
echo

echo "== 5. CKKS linear report preview =="
